...
def main():
    ...
    parser.add_argument("--show-encoding", action="store_true", default=False,
    ...
    normalized_cpu = args.cpu.lower()

    try:
        output = run_llvm_objdump(args.file, args.symbols, normalized_cpu)
    ...
    try:
        analyzed_output = run_llvm_mca(clean_assembly,
            args.syntax, args.all_stats, args.all_views, args.timeline, args.iterations, normalized_cpu, args.show_encoding, args.timeline_max_iterations, args.timeline_max_cycles
        )
    except FileNotFoundError:
