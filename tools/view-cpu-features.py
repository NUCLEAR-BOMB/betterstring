...
CPU_FEATURES_TABLE = {
    ...
    "KNC": ("vpandq", "vpandd", "vpadcd", "vpaddd", "vaddpd", "vaddps", "vaddnpd", "vaddnps", "vpaddsetcd", "vpaddsetsd", "vaddsetsps", "valignd", "vpandnd", "vpandnq", "vpblendmd", "vpblendmq", "vblendmpd", "vblendmps", "clevict0", "vpcmpd", "vpcmpud", "vcmppd", "vcmpps", "vpcmpeqd", "vpcmpgtd", "vpcmpltd", "vcvtpd2ps", "vcvtdq2pd", "vcvtudq2pd", "vcvtfxpntdq2ps", "vcvtfxpntudq2ps", "vcvtfxpntps2dq", "vcvtfxpntps2udq", "vcvtfxpntpd2dq", "vcvtfxpntpd2udq", "vcvtps2pd", "delay", "vexp223ps", "vmovdqa32", "vmovdqa64", "vmovapd", "vmovaps", "vloadunpackhd", "vloadunpackhq", "vloadunpackhpd", "vloadunpackhps", "vloadunpackld", "vloadunpacklq", "vloadunpacklpd", "vloadunpacklps", "vpackstorehd", "vpackstorehq", "vpackstorehpd", "vpackstorehps", "vpackstoreld", "vpackstorelq", "vpackstorelpd", "vpackstorelps", "vfixupnanpd", "vfixupnanps", "vpmadd231d", "vfmadd132pd", "vfmadd132ps", "vpmadd233d", "vfmadd233ps", "vfmsub132pd", "vfmsub132ps", "vfnmadd132pd", "vfnmadd132ps", "vfnmsub132pd", "vfnmsub132ps", "vgetexppd", "vgetexpps", "vgetmantpd", "vgetmantps", "vgmaxpd", "vgmaxps", "vgmaxabsps", "vgminpd", "vgminps", "vpgatherdd", "vgatherdps", "vpscatterdd", "vscatterdps", "vpgatherdq", "vgatherdpd", "vpscatterdq", "vscatterdpd"),
    "KNCNI": ("kmov", "kand", "kandn", "kandnr", "kconcath", "kconcatl", "kextract", "kmerge2l1h", "kmerge2l1l", "knot", "kor", "kortest", "kxnor", "kxor", "vlog2ps", "vpmaxsd", "vpmaxud", "vpminsd", "vpminud", "vmulpd", "vmulps", "vpmulhd", "vpmulhud", "vpmulld", "vpord", "vporq", "vpermf32x4", "vpermd", "vprefetch0", "vgatherpf0dps", "vgatherpf1dps", "vscatterpf0dps", "vscatterpf1dps", "vrcp23ps", "vroundps", "vrndfxpntpd", "vrndfxpntps", "vrsqrt23ps", "vpsbbd", "vpsbbrd", "vscaleps", "vpshufd", "vpslld", "vpsllvd", "spflt", "vpsrad", "vpsravd", "vpsrld", "vpsrlvd", "vmovnrapd", "vmovnraps", "vmovnrngoapd", "vmovnrngoaps", "vpsubd", "vsubpd", "vsubps", "vpsubrd", "vsubrpd", "vsubrps", "vpsubrsetbd", "vpsubsetbd", "vptestmd", "tzcnti", "vpxord", "vpxorq"),
}
